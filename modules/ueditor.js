...
var ueditor_config = require(path.join(
  process.cwd(),
  "/config/ueditor.config.js"
));
...
module.exports = function(req, res, next) {
  if (req.query.action == "config") {
    ...
    req.query.action === "uploadimage" ||
    req.query.action === "uploadfile" ||
    req.query.action === "uploadvideo"
  ) {
    ...
    busboy.on("file", function(fieldname, file, filename, encoding, mimetype) {
      ...
      file.on("end", function() {
        ...
        if (req.query.encode) {
          ...
          res.redirect(
            upload_config.get("simple_upload_redirect") +
              "?result=" +
    ...
    fs.readdir(
      path.join(process.cwd(), upload_config.get("upload_ueditor")),
      function(err, files) {
